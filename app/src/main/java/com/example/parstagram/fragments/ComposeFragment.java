...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        bttn_submit = view.findViewById(R.id.bttn_submitPic);
        bttn_takePic = view.findViewById(R.id.bttn_takePic);
        ivPreview = (ImageView) view.findViewById(R.id.iv_photoCapture);
        ...
        bttn_takePic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                handle_takePic();
            }
    ...
    private void handle_submitPost() {
        Log.i(TAG,"Submit button clicked! Handling new post...");
        String des = et_description.getText().toString();
        if (des.isEmpty())
        {
            Toast.makeText(getContext(), "No description on your post. Please type something...",Toast.LENGTH_SHORT).show();
            return;
        }
        if (photoFile == null || ivPreview.getDrawable()== null)
        {
            Toast.makeText(getContext(), "No image on your post...",Toast.LENGTH_SHORT).show();
            return;
        }
